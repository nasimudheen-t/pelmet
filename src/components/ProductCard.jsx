      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <div className="flex gap-2 mb-4">
          <div className="flex items-center gap-1 bg-slate-50 px-2 py-1 rounded-full">
            ...
            <span className="text-[9px] text-slate-600 font-medium">Virgin</span>
          </div>
          <div className="flex items-center gap-1 bg-slate-50 px-2 py-1 rounded-full">
            <Zap className="w-3 h-3 text-red-500" />
            <span className="text-[9px] text-slate-600 font-medium">Durable</span>
          </div>
        </div>
        ...
        <a
          ...
          className="mt-auto flex items-center justify-center gap-2 w-full py-2.5 rounded-full bg-red-600 hover:bg-red-700 text-white text-xs font-bold transition-all duration-200"
        >
