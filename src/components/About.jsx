...
const AnimatedCounter = ({ value, suffix }) => {
  ...
  return (
    <div ref={ref} className="text-4xl font-extrabold text-primary-600 mb-1 flex items-baseline justify-center sm:justify-start">
      <span>{count}</span>
      <span>{suffix}</span>
    </div>
  );
      ...
      <div className="container-custom">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 transition-all duration-500">
            ...
            <div className="grid grid-cols-3 gap-4 divide-x divide-slate-200">
              {siteData.about.stats.map((stat, idx) => (
                <div key={idx} className="flex flex-col items-center sm:items-start px-4 first:px-0">
          ...
          <div className="flex-1 relative w-full">
            ...
            {/* Image (optimized) */}
            <div className="relative z-10 w-full rounded-3xl overflow-hidden shadow-lg border border-white">
              <img
            ...
            {/* Light decorative elements (no blur heavy) */}
